...
const getTopRatedMovies = async () => {
    ...
    //PODER JUNTAR LA CANTIDAD DE PELICULAS DESEADAS, EN ESTE CASO: 100    
    while (index < 6) {
        
        //LE PIDE LAS PELICULAS A LA API
        const { data } = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=${index}&api_key=${API_KEY}`);
